...
import com.koch.bean.Setting.WatermarkPosition;
...
public class ImageUtil {
	 ...
	 *            缩放后的图片文件
	 */
	public static void zoom(File srcFile, File destFile, int destHeight, int destWidth) {
		try {
	 ...
	 * 
	 */
	public static void imageWatermark(File srcFile, File destFile, File watermarkFile, WatermarkPosition watermarkPosition, int alpha) {
		try {
			BufferedImage srcBufferedImage = ImageIO.read(srcFile);
			int srcWidth = srcBufferedImage.getWidth();
			int srcHeight = srcBufferedImage.getHeight();
