...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-edit" title="&nbsp;&nbsp;修  改  优  惠  券">
			<form id="editForm" action="${path }/back/coupon/edit.shtml" method="post">
				...
				<table width="100%" class="input tabContent table">
					<tr>
		    			...
		    			<td width="70%" align="left"><input type="text" name="name" value="${coupon.name }" class="text"/></td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right"><font color="red">*</font>&nbsp;前缀：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" name="prefix" value="${coupon.prefix }" class="text"/></td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;图标：&nbsp;&nbsp;</td>
		    			<td align="left">
		    				<input type="text" id="image" name="image" value="${coupon.image }" class="text"/>
		    				<input type="button" id="browserButton" class="button" value="选择文件.." />
		    				<a href="${coupon.image }" target="_blank">查看</a>
		    			</td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;开始时间：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" id="startDate" name="startDate" value="<fmt:formatDate value='${coupon.startDate }' pattern='yyyy-MM-dd HH:mm:ss'/>" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss', maxDate: '#F{$dp.$D(\'endDate\')}'});"/></td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;结束时间：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" id="endDate" name="endDate" value="<fmt:formatDate value='${coupon.endDate }' pattern='yyyy-MM-dd HH:mm:ss'/>" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss', minDate: '#F{$dp.$D(\'startDate\')}'});"/></td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;最小商品价格：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" id="minPrice" name="minPrice" value="${fn:currency(coupon.minPrice ,false) }" class="text" maxlength="20"/></td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;最大商品价格：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" name="maxPrice" value="${fn:currency(coupon.maxPrice ,false) }" class="text" maxlength="20"/></td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right"><font color="red">*</font>&nbsp;价格运算表达式：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" name="expression" value="${coupon.expression }" class="text" />&nbsp;表达式可用参数:(数量、价格) [+ - * /]&nbsp;&nbsp;&nbsp;示例:数量*价格*0.8</td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;设置：&nbsp;&nbsp;</td>
		    			<td align="left">
		    				<input type="checkbox" name="isEnabled" ${coupon.isEnabled ? 'checked="checked"' : '' } value="true"/>&nbsp;是否启用
		    				<input type="checkbox" id="isExchange" ${coupon.isExchange ? 'checked="checked"' : '' } name="isExchange" value="true"/>&nbsp;是否允许积分兑换
		    			</td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right"><font color="red">*</font>&nbsp;积分数：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" id="score" name="score" value="${coupon.score }" ${coupon.isExchange ? '' : 'disabled="disabled"' } class="text" maxlength="20"/></td>
		    		</tr>
				</table>
	   			<table width="100%" class="input tabContent table">
	   				<tr>
		    			<td><textarea name="introduction" style="width:1000px;height:350px;">${coupon.introduction }</textarea></td>
		    		</tr>
	    		</table>
