...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-add" title="&nbsp;&nbsp;新  增  促 销 ">
			<form id="editForm" action="${path }/back/promotion/add.shtml" method="post">
		    	<ul id="tab" class="tab">
				...
				<table width="100%" class="input tabContent table">
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input type="text" name="title" class="text"/></td>
		    		</tr>
		    		<tr>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input type="text" id="minQuantity" name="minQuantity" class="text" maxlength="20"/></td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;最大商品数量：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" name="maxQuantity" class="text" maxlength="20"/></td>
		    		</tr>
		    		<tr>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input type="text" name="priceExpression" class="text"/>&nbsp;表达式可用参数:(数量、价格) [+ - * /]&nbsp;&nbsp;&nbsp;示例:数量*价格*0.8</td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;积分运算表达式：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" name="scoreExpression" class="text"/>&nbsp;表达式可用参数:(积分、数量) [+ - * /]&nbsp;&nbsp;&nbsp;示例:数量*积分*0.8</td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;排序：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" name="orderList" class="text" maxlength="10"/></td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right">&nbsp;设置：&nbsp;&nbsp;</td>
		    			<td align="left">
		    				<input type="checkbox" name="isFreeDeliver" value="true"/>&nbsp;是否免运费
		    				<input type="checkbox" name="isAllowedCoupon" value="true"/>&nbsp;是否允许使用优惠券  
		    			</td>
		    		</tr>
				</table>
				<table width="100%" class="input tabContent table sort">
					<tr>
		    			...
		    			<td id="couponTd" width="80%">
		    				...
		    				<label><input type="checkbox" name="couponIds" value="${row.id }" class="coupon"/>&nbsp;${row.name }</label>
		    				</c:forEach>
		    				</c:if>
		    			</td>
		    		</tr>
	   				<tr>
		    			...
		    			<td id="gradeTd">
		    				...
		    				<label><input type="checkbox" name="gradeIds" value="${row.id }" class="grade"/>&nbsp;${row.name }</label>
		    				</c:forEach>
		    				</c:if>
		    			</td>
		    		</tr>
		    		<tr>
		    			...
		    			<td id="brandTd">
		    				...
		    				<label><input type="checkbox" name="brandIds" value="${row.id }" class="brand"/>&nbsp;${row.name }</label>
		    				</c:forEach>
		    				</c:if>
		    			</td>
		    		</tr>
	    		...
	    		<table id="giftPanel" data-name="giftItems" width="100%" class="input tabContent table">
					...
					<tr class="header">
						...
						<td width="10%" align="left">商品价格</td>
						<td width="10%" align="left">商品库存</td>
						<td width="10%" align="left">赠送数量</td>
						<td width="5%">操作</td>
					</tr>
	    		</table>
	   			<table width="100%" class="input tabContent table">
