...
<head>
	...
	<script type="text/javascript">
		function doEdit(id){
			window.location.href='${path}/back/question/edit/'+id+'.shtml';
		}
		$().ready(function(){
			...
			$mainTable.datagrid({
				url:'${path }/back/question/list/pager.shtml',
				idField:'id',
				toolbar:$toolBox,
				pagination:true,
				width:'auto',
				...
				columns:[[
					...
					{title:'问题',field:'value',align:'center',width:'400'},
					{title:'是否发布',field:'isPublish',align:'center',width:'150',
			...
			$("a[button='delete']").click(function(){
				...
				if(rows != null && rows != ""){
					$.post("${path}/back/question/delete.shtml",$(":checkbox[name='id']").serialize(),function(data){
						$.message(data);
...
<body>
	...
	<div id="toolBox">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="50">
					<a href="${path }/back/question/view.shtml" class="easyui-linkbutton" iconCls="icon-add" plain="true">新    增</a>
				...
				<td align="right">
					问题：<input type="text" id="name" class="text"/>
