...
<head>
	...
	<script type="text/javascript">
		function doEdit(id){
			window.location.href='${path}/back/grade/edit/'+id+'.shtml';
		}
		$().ready(function(){
			...
			$mainTable.datagrid({
				url:'${path }/back/grade/list/pager.shtml',
				idField:'id',
				treeField:'name',
				toolbar:$toolBox,
				pagination:true,
				...
				columns:[[
					...
					{title:'会员名称',field:'name',align:'center',width:'200'},
					{title:'会员类型',field:'typeName',align:'center',width:'150'},
					{title:'优惠比例',field:'discount',align:'center',width:'150'},
					{title:'消费金额',field:'expValue',align:'center',width:'150'},
			...
			$("a[button='delete']").click(function(){
				...
				if(rows != null && rows != ""){
					$.post("${path}/back/grade/delete.shtml",$(":checkbox[name='id']").serialize(),function(data){
						$.message(data);
...
<body>
	...
	<div id="toolBox">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="50">
					<a href="${path }/back/grade/view.shtml" class="easyui-linkbutton" iconCls="icon-add" plain="true">新    增</a>
				...
				<td align="right">
					等级名称：<input type="text" id="name" class="text middle"/>
