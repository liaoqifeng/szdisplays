...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-add" title="&nbsp;&nbsp;修  改  标  签">
			<form id="editForm" action="${path }/back/tag/edit.shtml" method="post">
		    	...
		    	<table class="table-edit" align="center" cellpadding="0" cellspacing="0">
		      		<tbody>
		      			<tr>
		      				...
		      				<td width="70%" align="left"><input type="text" name="name" value="${tag.name }" class="text"/></td>
		      			</tr>
		      			<tr>
		      				...
		      				<td align="left">
								<select name="type" class="select">
									...
									<option value="${row }" ${tag.type==row?'selected="selected"':'' }><fmt:message key="TagType.${row}"/></option>
									</c:forEach>
								</select>
							</td>
		      			</tr>
		      			<tr>
		      				...
		      				<td align="left">
		      					<input type="text" id="image" name="image" value="${tag.image }" class="text"/>
		      			...
		      			<tr>
		      				...
		      				<td align="left"><input type="text" name="remark" value="${tag.remark }" class="text"/></td>
		      			</tr>
		      			<tr>
		      				<td align="right"><fmt:message key='Common.label.orderList'/>：&nbsp;&nbsp;</td>
		      				<td align="left"><input type="text" name="orderList" value="${tag.orderList }" class="text short" /></td>
		      			</tr>
		      			<tr>
		      				<td height="60"></td>
		      				<td align="left">
