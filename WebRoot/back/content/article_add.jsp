...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-add" title="&nbsp;&nbsp;新  增  文  章">
			<form id="editForm" action="${path }/back/article/add.shtml" method="post">
		    	<table class="table-edit" width="100%" align="center" cellpadding="0" cellspacing="0">
		      		<tbody>
		      			<tr>
		      				...
		      				<td width="80%" align="left"><input type="text" name="articleTitle" class="text"/></td>
		      			</tr>
		      			<tr>
		      			...
		      			<tr>
		      				...
		      				<td align="left">
		      					<input type="checkbox" name="isPublish" value="true"/>&nbsp;<fmt:message key='Common.label.isPublish'/>
		      					<input type="checkbox" name="isTop" value="true"/>&nbsp;<fmt:message key='Common.label.isTop'/>
		      				</td>
		      			</tr>
		      			<tr>
		      				...
		      				<td align="left">
		      					<c:if test="${tags != null}">
		      						...
		      						<label><input type="checkbox" name="tagIds" value="${row.id }"/>&nbsp;${row.name }</label>
		      						</c:forEach>
		      					</c:if>
		      				</td>
		      			</tr>
		      			...
		      			<tr>
		      				...
		      				<td align="left">
		      					<input type="text" name="keywords" class="text long"/>
		      				</td>
		      			</tr>
		      			<tr>
		      				<td align="right"><fmt:message key='Common.label.seodiscription'/>：&nbsp;&nbsp;</td>
		      				<td align="left">
		      					<input type="text" name="describtion" class="text long"/>
		      				</td>
		      			</tr>
		      			<tr>
		      				<td height="60"></td>
