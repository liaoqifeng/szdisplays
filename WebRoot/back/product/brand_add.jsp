...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-add" title="&nbsp;&nbsp;新  增  品  牌">
			<form id="editForm" action="${path }/back/brand/add.shtml" method="post">
		    	<table class="table-edit" align="center" cellpadding="0" cellspacing="0">
		      		<tbody>
		      			...
		      			<tr>
		      				...
		      				<td align="left">
		      					<input type="text" id="image" name="image" class="text" maxlength="255" disabled="disabled"/>&nbsp;
		      			...
		      			<tr>
		      				...
		      				<td align="left"><input type="text" name="url" class="text long" value=""/></td>
		      			</tr>
		      			<tr>
		      			...
		      			<tr>
		      				...
		      				<td align="left"><textarea name="describtion" style="width:700px;height:400px;"></textarea></td>
		      			</tr>
		      			<tr>
		      				<td height="60"></td>
		      				<td align="left">
