...
(function($){
    $.fn.wBox = function(options){
        ...
        function afterHandleClick(){     
			...
			if(_this.YQ.timeout){
				time=setTimeout(_this.close,_this.YQ.timeout);
            }
        ...
        this.close=function (){
            if (C) {
                ...
                if(_this.YQ.go=="front"){
                	if(_this.YQ.hrefTarget=="top"){
	                	top.location.href=_this.YQ.url;
	                }else{
	                	window.location.href=_this.YQ.url;
	                }
                }else{
                	history.go(-1);
                }
