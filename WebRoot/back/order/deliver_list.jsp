...
<head>
	...
	<script type="text/javascript">
		$().ready(function(){
			...
			$mainTable.datagrid({
				url:'${path }/back/deliverInfo/list/pager.shtml',
				idField:'id',
				treeField:'name',
				toolbar:$toolBox,
				pagination:true,
				...
				columns:[[
					...
					{title:'收货人',field:'receiver',align:'center',width:'150'},
					{title:'创建日期',field:'createDate',align:'center',width:'150'},
					{title:'操作',field:'operator',align:'center',width:'100',
						formatter: function(value,row,index){
							var html = '<a href="${path}/back/deliverInfo/view.shtml?id='+row.id+'" style=" text-decoration:none;">[查看]</a>';
	                   		return html;
						}
					}
				]],
