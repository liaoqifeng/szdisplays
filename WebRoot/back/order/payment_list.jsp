...
<head>
	...
	<script type="text/javascript">
		$().ready(function(){
			...
			$mainTable.datagrid({
				url:'${path }/back/paymentInfo/list/pager.shtml',
				idField:'id',
				treeField:'name',
				toolbar:$toolBox,
				pagination:true,
				...
				columns:[[
					...
					{title:'支付状态',field:'statusName',align:'center',width:'100'},
					{title:'付款日期',field:'modifyDate',align:'center',width:'100',
						formatter: function(value,row,index){ return row.status=="success"?row.modifyDate:"-";}
					},
					{title:'创建日期',field:'createDate',align:'center',width:'100'},
					{title:'操作',field:'operator',align:'center',width:'100',
						formatter: function(value,row,index){
							var html = '<a href="${path}/back/paymentInfo/view.shtml?id='+row.id+'" style=" text-decoration:none;">[查看]</a>';
	                   		return html;
						}
					}
				]],
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<td align="right">
					...
					付款人：<input type="text" id="payer" class="text middle"/>
