...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-add" title="&nbsp;&nbsp;新  增  支  付  方  式">
			<form id="editForm" action="${path }/back/paymentway/add.shtml" method="post">
		    	<table class="table-edit" cellpadding="0" cellspacing="0">
		      		<tbody>
		      			<tr>
		      				<td width="15%" align="right"><font color="red">*&nbsp;&nbsp;</font>名称：&nbsp;&nbsp;</td>
		      				<td width="85%" align="left"><input type="text" name="name" class="text"/></td>
		      			</tr>
		      			<tr>
		      				...
		      				<td align="left">
		      					<select name="type">
		      						...
		      						<option value="${row }"><fmt:message key="PaymentwayType.${row }"/></option>
		      						</c:forEach>
		      						</c:if>
		      					</select>
		      				</td>
		      			...
		      			<tr>
		      				...
		      				<td align="left">
		      					<input type="text" name="timeout" class="text short"/>&nbsp;
		      			...
		      			<tr>
		      				...
		      				<td align="left">
		      					...
		      					<input type="checkbox" name="deliverwaysIds" value="${row.id }"/>${row.name }&nbsp;&nbsp;&nbsp;&nbsp;
		      					</c:forEach>
		      					</c:if>
		      				</td>
		      			</tr>
		      			<tr>
		      				...
		      				<td align="left">
		      					<input type="text" id="image" name="image" class="text long"/>
		      					<input type="button" id="browserButton" class="button" value="选择文件.." />
		      				</td>
		      			</tr>
		      			<tr>
		      				<td align="right">备注：&nbsp;&nbsp;</td>
		      				<td align="left"><input type="text" name="remark" class="text long"/></td>
		      			</tr>
		      			<tr>
		      			...
		      			<tr>
		      				...
		      				<td align="left">
		      				 	<textarea name="describtion" style="width:700px;height:300px;"></textarea>
		      				</td>
		      			</tr>
		      			<tr>
		      				<td height="60"></td>
