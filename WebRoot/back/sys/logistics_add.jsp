...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-add" title="&nbsp;&nbsp;新  增  物  流">
			<form id="editForm" action="${path }/back/logistics/add.shtml" method="post">
		    	<table class="table-edit" align="center" cellpadding="0" cellspacing="0">
		      		<tbody>
		      			...
		      			<tr>
		      				...
		      				<td align="left"><input type="text" name="url" class="text long"/></td>
		      			</tr>
		      			<tr>
