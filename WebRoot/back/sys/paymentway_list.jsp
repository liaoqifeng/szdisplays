...
<head>
	...
	<script type="text/javascript">
		function doEdit(id){
			window.location.href='${path}/back/paymentway/edit/'+id+'.shtml';
		}
		$().ready(function(){
			...
			$mainTable.datagrid({
				url:'${path }/back/paymentway/list/pager.shtml',
				idField:'id',
				treeField:'name',
				toolbar:$toolBox,
				rownumbers: true,
				...
				columns:[[
					...
					{title:'名称',field:'name',align:'center',width:'250'},
					{title:'超时时间',field:'timeout',align:'center',width:'150'},
			...
			$("a[button='delete']").click(function(){
				...
				if(rows != null && rows != ""){
					$.post("${path}/back/paymentway/delete.shtml",$(":checkbox[name='id']").serialize(),function(data){
						$.message(data);
...
<body>
	...
	<div id="toolBox">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="50">
					<a href="${path }/back/paymentway/view.shtml" class="easyui-linkbutton" iconCls="icon-add" plain="true">新    增</a>
				...
				<td align="right">
					支付方式名称：<input type="text" id="name" class="text middle"/>
