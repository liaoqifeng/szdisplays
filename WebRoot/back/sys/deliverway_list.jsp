...
<head>
	...
	<script type="text/javascript">
		function doEdit(id){
			window.location.href='${path}/back/deliverway/edit/'+id+'.shtml';
		}
		$().ready(function(){
			...
			$mainTable.datagrid({
				url:'${path }/back/deliverway/list/pager.shtml',
				idField:'id',
				treeField:'name',
				toolbar:$toolBox,
				rownumbers: true,
				...
				columns:[[
					...
					{title:'名称',field:'name',align:'center',width:'150'},
					{title:'首重',field:'firstWeight',align:'center',width:'120'},
					{title:'首重价格',field:'firstPrice',align:'center',width:'120'},
					{title:'续重',field:'conWeight',align:'center',width:'120'},
					{title:'续重价格',field:'conPrice',align:'center',width:'120'},
			...
			$("a[button='delete']").click(function(){
				...
				if(rows != null && rows != ""){
					$.post("${path}/back/deliverway/delete.shtml",$(":checkbox[name='id']").serialize(),function(data){
						$.message(data);
...
<body>
	...
	<div id="toolBox">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="50">
					<a href="${path }/back/deliverway/view.shtml" class="easyui-linkbutton" iconCls="icon-add" plain="true">新    增</a>
				...
				<td align="right">
					配送方式名称：<input type="text" id="name" class="text middle"/>
