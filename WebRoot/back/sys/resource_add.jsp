...
<body>
	...
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-save" title="新  增  资  源">
			<form id="editForm" action="${path }/back/resource/add.shtml" method="post">
		    	<table class="table-edit" align="center" cellpadding="0" cellspacing="0">
		      		<tbody>
		      			<tr>
		      				<td width="30%" align="right"><font color="red">*&nbsp;&nbsp;</font>资源名称：&nbsp;&nbsp;</td>
		      				<td width="70%" align="left"><input type="text" id="name" name="name" class="text middle" maxlength="30"/></td>
		      			</tr>
		      			<tr>
		      				<td align="right">资源路径：&nbsp;&nbsp;</td>
		      				<td align="left"><input type="text" id="value" name="value" class="text long" maxlength="30"/></td>
		      			</tr>
		      			<tr>
		      			...
		      			<tr>
		      				...
		      				<td align="left"><input type="text" id="orderList" name="orderList" class="text middle" maxlength="30"/></td>
		      			</tr>
		      			<tr>
		      				<td align="right">角色描述：&nbsp;&nbsp;</td>
		      				<td align="left"><textarea id="description" rows="5" cols="40" name="description"></textarea></td>
		      			</tr>
		      			<tr>
		      				<td height="60"></td>
		      				<td align="left">
