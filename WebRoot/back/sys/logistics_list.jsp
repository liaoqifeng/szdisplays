...
<head>
	...
	<script type="text/javascript">
		function doEdit(id){
			window.location.href='${path}/back/logistics/edit/'+id+'.shtml';
		}
		$().ready(function(){
			...
			$mainTable.datagrid({
				url:'${path }/back/logistics/list/pager.shtml',
				idField:'id',
				treeField:'name',
				toolbar:$toolBox,
				rownumbers: true,
				...
				columns:[[
					...
					{title:'物流名称',field:'name',align:'center',width:'400'},
					{title:'公司网址',field:'url',align:'center',width:'150'},
					{title:'排序',field:'orderList',align:'center',width:'150'},
					{title:'排序',field:'createDate',align:'center',width:'150'},
			...
			$("a[button='delete']").click(function(){
				...
				if(rows != null && rows != ""){
					$.post("${path}/back/logistics/delete.shtml",$(":checkbox[name='id']").serialize(),function(data){
						$.message(data);
...
<body>
	...
	<div id="toolBox">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="50">
					<a href="${path }/back/logistics/view.shtml" class="easyui-linkbutton" iconCls="icon-add" plain="true">新    增</a>
				...
				<td align="right">
					公司名称：<input type="text" id="name" class="text middle"/>
